...
def summary_v1(model, input_size, batch_size=-1, device="cuda"):
    ...
    dtypes=[torch.cuda.FloatTensor,torch.cuda.FloatTensor,torch.cuda.FloatTensor,torch.cuda.LongTensor]
    # batch_size of 2 for batchnorm
    x = [torch.rand(2, *input_size[i]).type(dtypes[i]) for i in range(len(input_size))]
    # print(type(x[0]))
